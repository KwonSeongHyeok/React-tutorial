...
Hook이라는 기능을 만듬
Hook 종류 = react에서 어떤 동작이나 상태를 표현하거나 변경할때 사용하는 기능들
1. useState
2. useEffect
3. useContext
4. useReducer
...
const State예제1 = () => {
    ...
    */
    ...
    return(
        ...
        // 그렇다면 왜 !Doctype 부터 html과 head body와 같은 태그는 사용 x ?
        // public -> index.html 코드 안에 <div id="root">라는 공간 안에
        // 우리가 만드는 javascript와 html, css와 같은 코드들이 모두 들어갈 것이기 때문에
        <>
        <h1>{test}</h1>
